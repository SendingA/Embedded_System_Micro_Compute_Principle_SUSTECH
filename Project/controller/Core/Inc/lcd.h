...
void LCD_draw_rt(uint16_t x, uint16_t y, uint16_t l1,uint16_t l2, uint16_t color) ;
void LCD_draw_finish(uint16_t x, uint16_t y, uint16_t l1,uint16_t l2, uint16_t color) ;
...
void lcd_showpic(uint16_t x, uint16_t y, uint16_t column,uint16_t  row,uint8_t l,unsigned short *pic);
void lcd_showpic_w(uint16_t x, uint16_t y, uint16_t column,uint16_t  row,uint8_t l,unsigned short *pic);
void lcd_rm_pic_w(uint16_t x, uint16_t y, uint16_t column,uint16_t  row,uint8_t l,unsigned short *pic);
void LCD_draw_round_rect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint16_t radius, uint16_t fill_color, uint16_t border_color);
//д���ݺ���
